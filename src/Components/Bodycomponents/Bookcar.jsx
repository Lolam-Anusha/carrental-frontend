            ...
            {isDivVisible && <div className="container border-4 border-white shadow-2xl overflow-x-hidden mx-auto bg-white absolute z-50 w-3/5 flex flex-col justify-center items-center" style={{ top: '170%', left: '50%', transform: 'translate(-50%, -50%)' }}>
                ...
                <div className="grid lg:grid-cols-2 w-full border-b">
                    <div className="justify-start py-4 px-4 w-full bg-white">
                        ...
                        <h3 className="py-2 font-bold font-sans text-lg"><CalendarMonthOutlinedIcon className="text-black"/> Pick up Date & Time</h3>
                        ...
                        <h3 className="py-2 font-bold font-sans text-lg"><CalendarMonthOutlinedIcon className="text-black"/> Drop of Date & Time</h3>
                        ...
                        <h3 className="py-2 font-bold font-sans text-lg"><LocationOnOutlinedIcon className="text-black"/> Pick up Location</h3>
                        <p className="text-base px-2 text-[#777] font-sans">{pickPlace}</p>
                        <h3 className="py-2 font-bold font-sans text-lg"><LocationOnOutlinedIcon className="text-black"/> Drop of Location</h3>
