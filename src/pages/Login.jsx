            ...
            {isUser &&
                <div className="">
                    ...
                    <div className="flex items-center justify-center ">
                        <div className="max-w-3xl p-4 mt-16 mx-auto">
                            <form method="POST">
                                <div className="">
                                    ...
                                    {/* ADD THIS LINE BELOW */}
                                    <div className="my-4 w-full flex justify-center">
                                        <p className="text-base text-[#777]">Don't have an account?
                                            <Link to="/register" className="text-orange font-bold px-2">Register here</Link>
                                        </p>
                                    </div>
